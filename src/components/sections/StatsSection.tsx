...
function StatItem({
  ...
  return (
    <div className="stat-item text-center">
      <p className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-pista-dark mb-2">
...
export default function StatsSection() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-off-white border-y border-pista/10">
