...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="relative h-[75vh] min-h-[480px] sm:h-[85vh] sm:min-h-[580px] lg:h-[92vh] lg:min-h-[680px]">
        <div
          ref={trackRef}
        ...
        >
          {heroBanners.map((banner, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center pt-[5.5rem] sm:pt-28 lg:pt-32">
                <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full">
                  <div className="max-w-xl lg:max-w-2xl">
                    ...
                    <div className="slide-cta flex flex-wrap gap-3 sm:gap-4">
                      ...
                      <button
                        type="button"
                        onClick={() => openWhatsApp(DEFAULT_WHATSAPP_GREETING)}
                        className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-[#25D366]/90 text-white rounded-full text-sm sm:text-base font-semibold hover:bg-[#25D366] transition-all duration-300 shadow-lg shadow-black/20 hover:scale-[1.03]"
